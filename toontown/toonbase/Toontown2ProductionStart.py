...
if os.environ.has_key("OTPKEY"):
    gameserver = os.environ['OTPKEY']
else:
	print("A critical security error occured!\nPlease speak to a Toonvolution Representative!\nERROR: OTPKEY NOT VALID OR EXPIRED (POSSIBLE TIME SLIP)")
	exit()
